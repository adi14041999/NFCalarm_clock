...
public class MainActivity extends Activity {
    ...
    public static final String TAG = "NfcALarm";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mNfcAdapter.isEnabled()) {
            ...
            mTextView.setText("NFC is available...");
        }
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(String result) {
             ...
             * CRUD Operations
             **/
            // Inserting TimeStamp to the Database
            String currentDateTimeString = DateFormat.getDateTimeInstance().format(new Date());
            //Toast.makeText(getApplicationContext(), currentDateTimeString, Toast.LENGTH_SHORT).show();
            db.addTimeStamp(currentDateTimeString);
            /*
            for (String member : db.getAllTimes()){
                Toast.makeText(getApplicationContext(), member, Toast.LENGTH_SHORT).show();
            }
            */
            Intent stopIntent = new Intent(getApplicationContext(), AlarmPlayer.class);
            stopIntent.putExtra("play", false);
